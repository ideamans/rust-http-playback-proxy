...
mod tests {
    ...
    async fn test_process_response_body_html() {
        ...
        let mut resource = Resource::new("GET".to_string(), "https://example.com/test.html".to_string());
        let html_content = b"<html><body><h1>Test</h1></body></html>";
        
        processor
            .process_response_body(&mut resource, html_content, Some("text/html; charset=utf-8"))
            .await
            .unwrap();
    ...
    async fn test_process_text_resource() {
        ...
        let mut resource = Resource::new("GET".to_string(), "https://example.com/script.js".to_string());
    ...
    async fn test_decompress_gzip() {
        ...
        let result = processor.decompress_body(&compressed, &Some(ContentEncodingType::Gzip)).unwrap();
    ...
    fn test_beautify_html() {
        ...
        let minified_html = "<html><head><title>Test</title></head><body><h1>Hello</h1></body></html>";
        let result = processor.beautify_content(minified_html, &Some("text/html".to_string())).unwrap();
    ...
    fn test_beautify_css() {
        ...
        let result = processor.beautify_content(minified_css, &Some("text/css".to_string())).unwrap();
